...
export default class Sticky extends Component {
  ...
  handleContainerEvent = ({
    ...
    const isSticky = preventingStickyStateChanges
      ? wasSticky
      : distanceFromTop + (this.props.offsetWhenSticky || 0) <= -this.props.topOffset &&
    ...
    const style = !isSticky
      ...
      : {
          ...
          top:
            bottomDifference > 0
              ? this.props.relative
                ? parent.offsetTop - parent.offsetParent.scrollTop + (this.props.offsetWhenSticky || 0)
                : (this.props.offsetWhenSticky || 0)
              : bottomDifference,
